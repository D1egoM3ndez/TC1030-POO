/*
 * Proyecto Batalla TC1030 Programación Orientada a Objetos
 * Diego Méndez Morales
 * A01713173
 * 03/06/2025
 * Objetos. Es un programa que ayuda a entender el modelaje de un juego RPG 
 * estilizado por Pokemon, donde por medio de objetos creados de este tipo se
 * hace una simulación de torneo como historia principal.
 */
...
// Clases ocupadas en la historia
 ...
 *
 * Función para validar entradas numéricas por parte del jugador
 * 
 * @param: int valor mínimo aceptado, int valor máximo aceptado
 * @return: variable numérica aceptada
*/
...
//"========================================"
/*
 * Calcular el daño provocado
 *
 * Función para calcular el daño producido por un ataque hacia el Pokemon del 
 * rival o del propio, se sigue la función que ocupa la saga de juegos
 * principales para calcular el daño provocado
 * 
 * @param: Pokemon pokemon propio, Pokemon pokemon del rival, Ataque ataque 
 * utilizado a calcular
 * @return: float daño provocado
*/
 ...
 *
 * Función que simula un combate Pokemon entre el propio y el rival, aqui
 * se verifica tanto la vida restante como la velocidad de cada Pokemon. Gana 
 * el último que quede con vida
 * 
 * @param: Pokemon pokemon propio, Pokemon pokemon del rival
 * @return: int variable numérica que verifica el ganador.
*/
 ...
 *
 * Función para validar la entrada de los nombres que intorduce el usuario
 * 
 * @param: Vector con los Pokemon registrados a escoger
 * @return: Objeto Pokemon correspondiente al nombre ingresado
*/
...
//"========================================"
/*
 * Historia de cada combate del juego
 *
 * Función que permite simular cada combate distinto del juego (en dado caso
 * de ir ganando serán máximo 3)
 * 
 * @param: Entrandor propio, Entrenador del rival
 * @return: int variable numérica que verifica el ganador
*/
...
//"========================================"
// Creacion de objetos de tipo Tipo
...
// Agregar efectividades a cada objeto Tipo creado para simular el RPG
...
// Creación de objetos de tipo Ataque para agregar a cada Pokemon para que
// pueda pelear
...
// Creación de objetos Pokemon para poder jugar correctamente, luego estos se 
// agregan a cada Entrenador para armar su equipo
...
//"========================================"
    ...
    Pokemon dragonite("Dragonite", "Ruta 22", 50, 0, 134.0, 95.0, 100.0, 
...
// Creación de objetos de tipo Entrenador, aquí se guardan los Pokemon de cada
// uno para poder ocuparlos despues. Se crea uno vacío que será el jugador en
// cada vuelta.
...
// Inicio del primer combate
    ...
    std::cout << "Veremos a quien te enfrentaras primero: " << std::endl;
...
// Conclusión del juego
    ...
    if(hist3 == 1){
        ...
        Pokedex guia("Pokedex");
        
        std::cout << "FELICIDADES, te has convertido en nuestro campeon" 
        " absoluto, debes estar orgulloso." 
        << std::endl;

        std::cout << "Como premio final, te hago entrega de una Pokedex"
        << "aqui podras ver todos aquellos Pokemon que te falten y datos"
        << "de campeones antiguos" << std::endl;

        std::cout << "Deseas visualizar los datos guardados: " << std::endl;
        std::cout << "0.- Si" << std::endl;
        std::cout << "1.- No" << std::endl;

        int entrada = valida_num(0,1);

        if (entrada == 0){
            guia.imprime_objetos();
        }
        else{
            std::cout << "Ok, hasta luego" << std::endl;
        }
