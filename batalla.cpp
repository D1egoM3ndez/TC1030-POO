...
//Inicio del juego
    ...
    std::cout << "Como premio final, te hago entrega de una Pokedex especial"
    << "aqui podras ver todos aquellos Pokemon que te falten y algunos datos"
    << "de campeones antiguos" << std::endl;

    Personaje* guia[100];

    Personaje* scyther = new Pokemon("Scyther", "Ruta 15", 50, bicho, volador);
    guia[0] = scyther;
    Personaje* mrmime = new Pokemon("Mr.Mime", "Ruta 14", 50, psiquico, hada);
    guia[1] = mrmime;
    Personaje* jynx = new Pokemon("Jynx", "Islas Espuma", 50, hielo, psiquico);
    guia[2] = jynx;
    Personaje* pinsir = new Pokemon("Pinsir", "Ruta 14", 50, bicho, nulo);
    guia[3] = pinsir;
    Personaje* tauros = new Pokemon("Tauros", "Zona Zafari", 50, normal, nulo);
    guia[4] = tauros;
    Personaje* electabuzz = new Pokemon("Electabuzz", "Central Electrica", 50,
    electrico, nulo);
    guia[5] = electabuzz;
    Personaje* magmar = new Pokemon("Magmar", "Mansion Pokemon", 50, fuego, 
    nulo);
    guia[6] = magmar;
    ...
    if (data == 0){
        ...
        std::cout << "Ok, sera para la proxima, gracias por participar" 
        << std::endl;
    }
